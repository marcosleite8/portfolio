...
export default function Layout() {
  return (
    <div className="min-h-screen bg-[#121417] text-white p-4 md:p-8 font-sans flex items-center justify-center relative overflow-hidden">
      ...
      {/* Main Container */}
      <div className="w-full max-w-7xl bg-[#1E2126]/80 backdrop-blur-xl border border-white/10 rounded-[2rem] p-6 flex flex-col relative z-10 shadow-2xl mb-8 min-h-[85vh]">
        ...
        <div className="absolute -bottom-6 left-1/2 transform -translate-x-1/2 bg-[#2A2D35] border border-white/10 rounded-full px-4 md:px-6 py-3 flex items-center gap-4 md:gap-6 shadow-2xl z-50 w-max max-w-[95vw] overflow-x-auto custom-scrollbar">
